...
public class UpdateTeacher extends JFrame implements ActionListener{
	...
	UpdateTeacher() {
		...
		JLabel lblrollumber = new JLabel("Select Employee Id ");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == submit){
			...
			try {
				String query = "update teacher set address='"+address+"', phone='"+phone+"', email='"+email+"', education='"+qualification+"', department='"+department+"' where empId='"+empId+"'" ;
